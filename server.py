...
class SolarData(BaseModel):
    ...
    pv_power_kw: Optional[float] = None  # Added PV Power
    battery_voltage: Optional[float] = None

class SystemSummary(BaseModel):
    total_load_kw: float
    total_pv_kw: float  # Added Total PV
...
# Initialize the persistent instrument
...
def get_inverter_data(slave_id):
    try:
        ...
        return {
            ...
            "pv_kw": round(pv_w / 100, 3) # inverters report PV power in 10W increments rather than 1W increments.
        }
